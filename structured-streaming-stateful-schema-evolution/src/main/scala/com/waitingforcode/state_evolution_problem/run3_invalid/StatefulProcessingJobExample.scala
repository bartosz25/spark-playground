package com.waitingforcode.state_evolution_problem.run3_invalid

import com.waitingforcode.state_evolution_problem.{CheckpointLocation, DataGenerator, Letter}
...
object StatefulProcessingJobExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val lettersStateOutput = groupedLetters.transformWithState(
      statefulProcessor=new LetterProcessorV3(),
