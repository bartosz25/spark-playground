...
object DeltaLakeDynamicPartitionOverwriteExample {

  def main(args: Array[String]): Unit = {
    val outputDir = "/tmp/spark-playground/partitions/delta-lake-dynamic-partition-overwrite-example"
    ...
    Seq((3, "Cc", "cc"), (5, "E", "e")).toDF("nr", "upper_case", "lower_case").write.format("delta")
