...
def read_command(serializer, file):
    ...
    print(f'Read command as {command}')
...
def main(infile, outfile):
    ...
    try:
        ...
        def process():
            ...
            print(f'Worker process() infile {type(infile)} // infile')
            print(f'Worker process() deserializer {type(deserializer)}')
            out_iter = func(split_index, iterator)
            print(f'Worker process() {type(iterator)} // {type(out_iter)}')
            print(f'Worker process() {type(iterator)} // {type(out_iter)}')
            try:
